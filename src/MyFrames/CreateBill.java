...
//		String query="INSERT INTO `bill`(bno,`cname`,`caddress`,cphone,pid,`pname`,qty,amt,`pdate`) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"','"+textField.getText()
//		+"',"+textField_1.getText()+",'"+jComboBox2.getSelectedItem()+"','"+jTextField3.getText()+"',"+jTextField5.getText()+","+jTextField7.getText()+",'"+jTextField8.getText()+"' );";
...
//		}
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		String insertBill = "INSERT INTO `bill`(bno,`cname`,`caddress`,cphone,pid,`pname`,qty,amt,`pdate`) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"','"+textField.getText()
							+"',"+textField_1.getText()+",'"+jComboBox2.getSelectedItem()+"','"+jTextField3.getText()+"',"+jTextField5.getText()+","+jTextField7.getText()+",'"+jTextField8.getText()+"' );";
		Connection con;
		Statement st;
		// ResultSet rs1;
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
		...
		String remove = "DELETE from `bill` where bno = "+jTextField1.getText() 
						+" and `cname` = '"+jTextField2.getText()+"' and `pname` = '"+jTextField3.getText()+"' and qty = "+jTextField5.getText()+" and `pdate` = '"+jTextField8.getText()+"';";
